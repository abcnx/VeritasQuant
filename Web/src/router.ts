...
import MetaExchangeView from './views/Meta/Finv/Quote/Metadata/MetaExchangeView.vue'
import MetaMarketView from './views/Meta/Finv/Quote/Metadata/MetaMarketView.vue'
import MetaSecurityView from './views/Meta/Finv/Quote/Metadata/MetaSecurityView.vue'
// 量化回测（通用量化策略验证）
