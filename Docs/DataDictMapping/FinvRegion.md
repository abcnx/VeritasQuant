...
> 数据表：`finv_region`（表结构：[`Deploy/Migrations/V6__finv_region.sql`](../../Deploy/Migrations/V6__finv_region.sql)；约束放宽：[`Deploy/Migrations/V11__finv_region_allow_idx_zero.sql`](../../Deploy/Migrations/V11__finv_region_allow_idx_zero.sql)；初始数据：[`Deploy/Migrations/V100004__finv_region_seed.sql`](../../Deploy/Migrations/V100004__finv_region_seed.sql)）
