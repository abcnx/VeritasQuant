...
| 14 | 资金管理 | 一级叶子 | `fund` | `mdi-cash-multiple` | `/meta/finvquant/fund` | `Web/src/views/FundManageView.vue` | `GET .../Backtest/Run/List`、`GET .../Backtest/Run/Equity` | [Backtest/FundPositionManage.md](Backtest/FundPositionManage.md) |
| 15 | 持仓管理 | 一级叶子 | `position` | `mdi-briefcase-variant-outline` | `/meta/finvquant/position` | `Web/src/views/PositionManageView.vue` | `GET .../Backtest/Run/List`、`GET .../Backtest/Run/Equity`、`GET .../Backtest/Run/Trades` | [Backtest/FundPositionManage.md](Backtest/FundPositionManage.md) |
...
| 18 | 仿真数据验证 | 一级叶子 | `simulation-data` | `mdi-database-sync-outline` | `/meta/finvquant/simulation/data` | `Web/src/views/PlaceholderView.vue` | —（规划中） | [Backtest/Placeholder.md](Backtest/Placeholder.md) |
| 19 | 模拟盘验证 | 一级叶子 | `simulation-paper` | `mdi-account-cash-outline` | `/meta/finvquant/simulation/paper` | `Web/src/views/PlaceholderView.vue` | —（规划中） | [Backtest/Placeholder.md](Backtest/Placeholder.md) |
| 20 | 实盘仿真验证 | 一级叶子 | `simulation-live-sim` | `mdi-robot-outline` | `/meta/finvquant/simulation/live-sim` | `Web/src/views/PlaceholderView.vue` | —（规划中） | [Backtest/Placeholder.md](Backtest/Placeholder.md) |
| 21 | 实盘交易 | 一级叶子 | `live-trading` | `mdi-cash-register` | `/meta/finvquant/live-trading` | `Web/src/views/PlaceholderView.vue` | —（规划中） | [Backtest/Placeholder.md](Backtest/Placeholder.md) |
