# POST /API/V1/Meta/Finv/Quant/Quote/Import/Upload — 历史行情文件导入
...
- **方法**：`POST`
- **路径**：`/API/V1/Meta/Finv/Quant/Quote/Import/Upload`
...
```bash
curl -X POST http://localhost:16001/API/V1/Meta/Finv/Quant/Quote/Import/Upload \
