...
| 17 | GET | `/API/V1/Meta/FinvQuant/Backtest/Strategy/List` | 分页查询回测策略（结构化定义） | [Backtest/StrategyList.md](Backtest/StrategyList.md) | 策略管理（[Backtest/StrategyManage.md](../Menu/Backtest/StrategyManage.md)）、黄金期货合约回测验证（[Backtest/BacktestGoldFutures.md](../Menu/Backtest/BacktestGoldFutures.md)） |
| 18 | GET | `/API/V1/Meta/FinvQuant/Backtest/Strategy/Get` | 查询策略详情 | [Backtest/StrategyGet.md](Backtest/StrategyGet.md) | 策略管理（同上） |
| 19 | POST | `/API/V1/Meta/FinvQuant/Backtest/Strategy/Save` | 新增/修改策略（定义编译校验） | [Backtest/StrategySave.md](Backtest/StrategySave.md) | 策略管理（同上） |
| 20 | POST | `/API/V1/Meta/FinvQuant/Backtest/Strategy/Toggle` | 切换策略回测开关 | [Backtest/StrategyToggle.md](Backtest/StrategyToggle.md) | 策略管理（同上） |
| 21 | POST | `/API/V1/Meta/FinvQuant/Backtest/Strategy/Delete` | 删除策略（已关联任务禁止） | [Backtest/StrategyDelete.md](Backtest/StrategyDelete.md) | 策略管理（同上） |
| 22 | GET | `/API/V1/Meta/FinvQuant/Backtest/Account/List` | 分页查询回测账户（多用户/多子账户） | [Backtest/AccountList.md](Backtest/AccountList.md) | 账户管理（[Backtest/AccountManage.md](../Menu/Backtest/AccountManage.md)）、黄金期货合约回测验证（同上） |
| 23 | GET | `/API/V1/Meta/FinvQuant/Backtest/Account/Get` | 查询账户详情 | [Backtest/AccountGet.md](Backtest/AccountGet.md) | 账户管理（同上） |
| 24 | POST | `/API/V1/Meta/FinvQuant/Backtest/Account/Save` | 新增/修改账户 | [Backtest/AccountSave.md](Backtest/AccountSave.md) | 账户管理（同上） |
| 25 | POST | `/API/V1/Meta/FinvQuant/Backtest/Account/Toggle` | 切换账户回测开关 | [Backtest/AccountToggle.md](Backtest/AccountToggle.md) | 账户管理（同上） |
| 26 | POST | `/API/V1/Meta/FinvQuant/Backtest/Account/Delete` | 删除账户（已关联任务禁止） | [Backtest/AccountDelete.md](Backtest/AccountDelete.md) | 账户管理（同上） |
| 27 | POST | `/API/V1/Meta/FinvQuant/Backtest/Run/Create` | 创建并启动回测任务（异步执行） | [Backtest/RunCreate.md](Backtest/RunCreate.md) | 黄金期货合约回测验证（[Backtest/BacktestGoldFutures.md](../Menu/Backtest/BacktestGoldFutures.md)） |
| 28 | GET | `/API/V1/Meta/FinvQuant/Backtest/Run/List` | 分页查询回测任务 | [Backtest/RunList.md](Backtest/RunList.md) | 回测分析（[Backtest/BacktestAnalysis.md](../Menu/Backtest/BacktestAnalysis.md)）、黄金期货合约回测验证、资金/持仓管理（[Backtest/FundManage.md](../Menu/Backtest/FundManage.md)、[Backtest/PositionManage.md](../Menu/Backtest/PositionManage.md)） |
| 29 | GET | `/API/V1/Meta/FinvQuant/Backtest/Run/Get` | 查询任务详情（含快照/报告） | [Backtest/RunGet.md](Backtest/RunGet.md) | 回测分析（同上） |
| 30 | POST | `/API/V1/Meta/FinvQuant/Backtest/Run/Cancel` | 取消运行中任务 | [Backtest/RunCancel.md](Backtest/RunCancel.md) | 回测分析（同上） |
| 31 | GET | `/API/V1/Meta/FinvQuant/Backtest/Run/Report` | 查询回测报告（汇总指标） | [Backtest/RunReport.md](Backtest/RunReport.md) | 回测分析（同上） |
| 32 | GET | `/API/V1/Meta/FinvQuant/Backtest/Run/Equity` | 净值曲线数据（余额/收益率/收益额/持仓金额/回撤） | [Backtest/RunEquity.md](Backtest/RunEquity.md) | 回测分析、资金/持仓管理（同上） |
| 33 | GET | `/API/V1/Meta/FinvQuant/Backtest/Run/Trades` | 成交记录 | [Backtest/RunTrades.md](Backtest/RunTrades.md) | 回测分析、持仓管理（同上） |
