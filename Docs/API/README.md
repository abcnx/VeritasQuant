...
- **详细接口文档**：
  ...
  - 回测策略管理（`/API/V1/Meta/FinvQuant/Backtest/Strategy/*`，**一个接口一个文档**）：
  ...
  - 回测账户管理（`/API/V1/Meta/FinvQuant/Backtest/Account/*`）：
  ...
  - 回测任务（`/API/V1/Meta/FinvQuant/Backtest/Run/*`）：
  ...
  - 回测环境管理（`/API/V1/Meta/FinvQuant/Backtest/Environment/*`）：
  ...
  - 回测模板管理（`/API/V1/Meta/FinvQuant/Backtest/Template/*`）：
