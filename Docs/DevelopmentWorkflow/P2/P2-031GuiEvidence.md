...
### API Client（`apps/gui_client/ApiClient.py`）
...
### GUI 框架（`apps/gui_client/GuiApp.py`）
...
### 入口（`apps/gui_client/GuiServer.py`）
...
## 测试结果
- `tests/unit/apps/gui_client/test_api_client.py`：9 个测试通过
- `tests/unit/apps/gui_client/test_gui_framework.py`：6 个测试通过
